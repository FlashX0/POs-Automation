...
const mongoose = { connection: { readyState: 0, once: (event: string, cb: any) => { if (event === "open") { setTimeout(cb, 100); } } } };
...
// MongoDB has been completely removed. MongooseModels are deprecated and stubbed out.
